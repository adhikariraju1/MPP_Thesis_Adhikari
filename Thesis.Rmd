...
Although, this paper will analyze economic voting from the persepective of the Republican party and not from the incumbent party, it is nonetheless to control of incumbency effect. Many political scientists have agreed to the idea of analyzing the economic vote through the perspective of an incumbent. The main idea behind this is that voters assess the performance of the incumbent party or candidate and use their vote as a means to determine either to reelect them or to choose the opposition candidate or party. Key's (1970)[^13] retrospective model uses bounded rationality theory to claim that voters use their vote as either a reward or a punishment depending on how the incumbent government performed [@Kim2003]. In economic voting, incumbents are given utmost importance because people often relate economic performance with the incumbent party or candidate. Hence, if the economy is doing well, it helps the incumbent party or candidate and if it is doing bad it hurts them. 
