...
_TableX_ shows the states where the counties stayed Republican between 2012 and 2016 and in how many of those counties our model made an underprediction of the Republican voteshare. We can see that 2361 counties stayed Republican between 2012 and 2016. Out of them, the Republican vote share of 1945 counties were underpredicted by our model.

In a nutshell, what that means is that we underpredicted the Republican vote share in most of the counties that were won by Donald Trump in 2016. This may say that the forecast was a failure. However, if we look at the _maps_ below, we find an interesting observation that speaks volumes on the success of the forecasting model.
...
DOnald Trump is not a generic Republican. THe model would have performed well for a generic republican running atop the ballot, but we see a systemic difference in the way _Region Name_ voted, and how our model predicted them to be. 

The maps below show a systemic difference in _Region Name_.

What caused the Republican-leaning counties to vote significantly higher for Donald Trump and what led the Democratic -leaning counties to switch to Republican is a question that needs more exploration and this forecasting exercise provides the perfect premise to do so. In order to understand this difference (residual), we will need to test various rival hypothesis with the aim of explaining the effect that Donald Trump had that other traditional generic Republicans didn't have in the past.   
