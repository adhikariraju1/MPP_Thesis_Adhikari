...
#TOTO: Separating the column GeoName into "county" and "state". Then removing all the rows that are not counties such as "United States" or "Alabama", Mississippi", etc.
