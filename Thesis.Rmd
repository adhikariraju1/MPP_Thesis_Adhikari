...
The distribution plot shows an extreme right skewness with population due to the presence of some extremely populous county like the Los Angeles county in California that has a population of more than 9 million. _how to correct_ _remove_ or _log_ or _categorical variable_
Similarly, the plot of rural_percent shows _a weird shape_ _why explain_ _changing them into categorical will take away the fixed effects_
...
The table below shows the states where the previously Democratic counties turned Republican and their voteshare was underpredicted by our model:

```{r}
table2_b2rh
```

The table shows the states where the counties stayed Republican and their voteshare was underpredicted by our model:
