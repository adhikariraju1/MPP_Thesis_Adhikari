...
df3 <- merge(df2, incumbency, by = 'year', all.x = TRUE)  #TOTO: Should dummy variable be left as numeric or changed to factor?
...
write.xlsx(election_df, "C:/RajuPC/MPP Final Thesis/MPP_Thesis_Adhikari/df3.xlsx")
