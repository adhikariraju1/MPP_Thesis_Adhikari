...
geo_seperate <- function(text, digit = 1) {
  # This function is to use the text in the column
  # GeoName and sepeate them into two parts; the one
  # with the state and the one with counties. Then use
  # dplyr to mutate the columns respectivly
  ...
  if (length(temp.text) == 3) {
    # Correcting the state and county names if more than one comma 
    # in their names
