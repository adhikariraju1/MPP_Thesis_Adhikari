...
```{r}
race_al <- read.fwf("C:/RajuPC/MPP Final Thesis/MPP_Thesis_Adhikari/al.1990_2014.19ages.adjusted.txt", widths = c(4,2,2,3,2,1,1,1,2,8), colClasses = "character")

colnames(race_al) <- c("year", "state", "state.fips", "county.fips", "registry", "race", "origin", "sex", "age.group", "population")

race_al2 <- fread("C:/RajuPC/MPP Final Thesis/MPP_Thesis_Adhikari/al.1990_2014.19ages.adjusted.txt", stringsAsFactors = FALSE)
